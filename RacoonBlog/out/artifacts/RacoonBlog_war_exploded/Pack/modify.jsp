...
<div style="margin: 0 auto; width: 350px; height: 550px; border: solid black; border-radius: 20px;background-color: rgba(255,255,255,0.3)">
    <div style="height: 130px">
        <h1 style="text-align: center; font-size: 50px">用户信息管理</h1>
    </div>
    <center>
        <div style="height: 315px;font-size: 10px">
            ...
            <form id="form1" action="RegisterAction" method="get">
                <table style="border-collapse: separate; border-spacing: 15px;">
                    ...
                    <tr>
                        <th>新用户名</th>
                        <th><input id="input2" type="text" name="username"
                                   value="" style="width: 150px; height: 30px; border-radius: 5px"></th>
                    </tr>
                    <tr>
                        <th>新密码</th>
                        <th><input id="input3" type="password"
                                   name="password" value=""
                                   style="width: 150px; height: 30px; border-radius: 5px"></th>
                    </tr>
                </table>
                <br>
                <input type="submit" value="修改" name="submit" style="height: 30px; width: 70px;  border-radius: 5px">
            </form>
